...
//                case "USD":
//                case "EUR":
//                    settingsForKeyboard.toggleCurrencySelection(UserSettings.Currency.valueOf(text), chatId);
//                    break;
            ...
            if ("USD".equals(text) || "EUR".equals(text)) {
                ...
                if (settingsForKeyboard.selectedCurrencies.contains(currency)) {
                    settingsForKeyboard.selectedCurrencies.remove(currency);
                } else {
                    settingsForKeyboard.selectedCurrencies.add(currency);
                }
